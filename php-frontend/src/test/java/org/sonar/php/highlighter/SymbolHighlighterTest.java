...
public class SymbolHighlighterTest {
  ...
  private void checkSymbolExistence(int line, int column, boolean mustHaveReferences) {
    String componentKey = "moduleKey:" + file.getName();
    new SymbolChecker(componentKey).checkSymbolExistence(context, line, column, mustHaveReferences);
  }
